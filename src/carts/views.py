...
class CartViewSet(ModelViewSet):
    ...
    @swagger_auto_schema(
        operation_summary=cart_list_summary,
        operation_description=cart_list_description,
        responses=cart_list_responses,
        tags=["Carts"]
    )
...
class CartItemViewSet(ModelViewSet):
    ...
    @swagger_auto_schema(
        operation_summary=cart_item_create_summary,
        operation_description=cart_item_create_description,
        request_body=CartItemSerializer,
        responses=cart_item_create_responses,
        tags=["Carts"]
    )
    ...
    @swagger_auto_schema(
        operation_summary=cart_item_update_summary,
        operation_description=cart_item_update_description,
        request_body=CartItemSerializer,
        responses=cart_item_update_responses,
        tags=["Carts"]
    )
